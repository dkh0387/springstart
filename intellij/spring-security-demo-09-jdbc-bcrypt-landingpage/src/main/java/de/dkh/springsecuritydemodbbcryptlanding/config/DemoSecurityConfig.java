...
public class DemoSecurityConfig {
    ...
    /**
     * Reference to the security data source defined in {@linkplain de.dkh.springsecuritydemodbbcrypt.config.DemoConfig#securityDataSource()}.
     */
    @Autowired
     ...
     * 8. Before the login page we add a landing page mapped by {@code "/"}. See {@linkplain de.dkh.springsecuritydemodbbcrypt.controller.DemoController}.
     * This page is enabled for all {@permittAll()}
     *
     * @param http
     * @return
     * @throws Exception
