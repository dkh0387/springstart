...
/**
 * Costum bean processing to call {@code destroy()} method on all bean instances created in scope {@code prototype}.
 * Methods here will be calling by Spring by closing the Spring container anyway, so only the implementation of {@linkplain BeanPostProcessor} needed!
 */
