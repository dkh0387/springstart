...
public class SportConfig {
     ...
     * NOTE: the method name is the bean ID of the class (here {@linkplain AdvancedCoach}) which we call in {@linkplain AdvancedDemoApp} (not in the bean class itself)!
     * Since the {@linkplain AdvancedCoach} is not annotated as a component anymore, the bean ID is defined through this method.
     ...
     * NOTE: since we let the {@linkplain Scope} being singleton, any call of this method will check, if there is an instance of {@linkplain AdvancedCoach} already created.
