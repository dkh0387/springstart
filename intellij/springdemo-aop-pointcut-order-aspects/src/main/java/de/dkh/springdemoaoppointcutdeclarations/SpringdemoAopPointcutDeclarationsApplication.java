...
import de.dkh.springdemoaoppointcutdeclarations.aspect.DemoLoggingAspect;
...
public class SpringdemoAopPointcutDeclarationsApplication {
    ...
    public static void main(String[] args) {
         ...
         */
        accountDAO.addAccounts(List.of(new Account()));
         ...
         * {@linkplain DemoLoggingAspect#beforeUpdateAdvice()}!
         */
